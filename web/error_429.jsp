<%-- 
    Document   : page_403
    Created on : 29/08/2016, 02:17:53 PM
...
<html lang="es">
    <head>
        ...
        <title>Error 429 - Muchas Peticiones</title>
                ...
                <div class="col-md-12">
                    <div class="col-middle">
                        <div class="text-center text-center">
                            <h1 class="error-number">Error 429</h1>
                            <h2>Bombardeo Detectado</h2>
                            <h5><p>Al parecer nuestra base esta siendo bombardeada de peticiones, nuestro servidor a blindado la base. Se trata de un error? <a href="report.jsp">Reportalo.</a></h5>
                            </p>
