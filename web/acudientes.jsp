<%--   
    Document   : acudientes
    Created on : 20/10/2016, 01:25:50 PM
...
<%
    ...
    ArrayList<Tipo_Documento> LTD = new ArrayList<Tipo_Documento>();
    ArrayList<Perfil> LP = new ArrayList<Perfil>();
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            <form class="form-horizontal form-label-left" id="acudientesform" method="POST" action="./Acudientes">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="number" id="txtnumerodocumento" name="txtnumerodocumento" value="<%=numero_documento_persona != null ? numero_documento_persona : ""%>" required="required" data-validate-length-range="6,15" class="form-control col-md-7 col-xs-12" onkeypress="return BuscarEnter(event)" <%=autofocusdocumento%>>
                                                </div>
                                            </div>
                                            <div class="item form-group">
