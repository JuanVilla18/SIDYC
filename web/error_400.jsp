...
<html lang="es">
    <head>
        ...
        <title>Error 400 - Mal Chico</title>
                ...
                <div class="col-md-12">
                    <div class="col-middle">
                        <div class="text-center text-center">
                            <h1 class="error-number">Error 400</h1>
                            <h2>Mal Hecho!</h2>
                            <h5><p>Estas intentando hacer algo indebido. Se trata de un error? <a href="report.jsp">Reportalo.</a></h5>
