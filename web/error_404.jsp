<%-- 
    Document   : error_404
    Created on : 11/09/2016, 02:53:38 PM
...
<html lang="es">
    <head>
        ...
        <title>Error 404 - Pagina Desconocida</title>
                ...
                <div class="col-md-12">
                    <div class="col-middle">
                        <div class="text-center text-center">
                            ...
                            <h2>Disculpa. Hemos tenido un problema en la central</h2>
                            <h5><p>La pagina que intentas buscar no existe. Se trata de un error? <a href="report.jsp">Reportalo.</a></h5>
                            </p>
