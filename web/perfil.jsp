...
<%--
    Document   : perfil
    Created on : 14/09/2016, 03:48:12 PM
...
<html lang="es">
    <head>
        ...
        <title>Sistema de Control e Inventario Deportivo - SIDYC</title>
    ...
    <body class="nav-md">
                    ...
                    <div class="left_col scroll-view">
                        ...
                        <jsp:include page="menu.jsp"></jsp:include>
                            ...
                            <div class="sidebar-footer hidden-small">
                                <a data-toggle="tooltip" data-placement="top" title="Configuraciones" href="configuracion.jsp">
                        ...
                        <div class="">
                            <div class="page-title">
                                <div class="title_left">
                                    <h3>Sistema de Control e Inventario Deportivo</h3>
                                </div>
        ...
        <script src="scripts/morris.js/morris.min.js"></script>
        <!-- bootstrap-progressbar -->
