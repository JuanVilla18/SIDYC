<%--   
    Document   : usuarios
    Created on : 09/10/2016, 11:17:27 AM
...
<html lang="es">
    <head>
        ...
        <title>Usuarios - I.E. La Independencia</title>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            <form class="form-horizontal form-label-left" id="usuariosform" method="POST" action="./Usuarios">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select id="cboperfil" name="cboperfil" required="required" class="form-control col-md-7 col-xs-12">
                                                        <option value="<%=Resolve.ResolveSiglaPerfil("P", perfil, genero) != null ? Resolve.ResolveSiglaPerfil("P", perfil, genero) : ""%>"><%=Resolve.ResolveSiglaPerfil("P", perfil, genero) != null ? Resolve.ResolveSiglaPerfil("P", perfil, genero) : "Seleccione"%></option>
                                                        <%if (LP != null) {%>
                                                        <%for (Perfil Per : LP) {%>
                                                        <option value="<%=Per.getCodigo_perfil()%>"><%=Per.getNombre()%></option>
                                                        <%}%>
                                                        <%}%>
                                                    </select>
                                                </div>
